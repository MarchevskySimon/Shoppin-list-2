import { __VLS_internalComponent, __VLS_componentsOption, __VLS_name } from "./a-list-item.vue";
...
else if (__VLS_ctx.shoppingLists.error) {
{
...
(__VLS_ctx.shoppingLists.length);
